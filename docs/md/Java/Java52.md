...
public class E_113 {
    ...
    static class DefaultSingletonBeanRegistry implements SingletonBeanRegistry {
        ...
        private Map<String, Object> disposableBeans = new HashMap<>();
        ...
        // 添加销毁方法对象
        protected void addDisposableBean(String beanName, Object disposableBean) {
            disposableBeans.put(beanName, disposableBean);
        }

        public void destroySingletons() {
            Collection<Object> values = disposableBeans.values();
            try {
    ...
    static abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
        ...
        protected void registerDisposableBean(String beanName, Object disposableBean) {
            addDisposableBean(beanName, disposableBean);
        }
        ...
        private Object initializeBean(String beanName, Object bean, BeanDefinition beanDefinition) {
            ...
            try {
                ...
                throw new BeanCreationException("Invocation of init method of bean[" + beanName + "] failed", e);
            }
    ...
    //  定义销毁方法适配器 (接口和配置)
    static class DisposableBeanAdapter implements DisposableBean {
        private Object bean;
        private String beanName;
        private String destroyMethodName;
        ...
        public void destroy() throws Exception {
            ...
            // 2. 配置信息 destroy-method {判断是为了避免二次执行}
        ...
        private void doLoadBeanDefinitions(InputStream is) throws DocumentException, ClassNotFoundException {
            ...
            for (Element beanElement : elements) {
                ...
                if ("bean".equals(beanElement.getName())) {
                    ...
                    String initMethod = beanElement.attribute("init-method") == null ? "" : beanElement.attribute("init-method").getValue();
                    String destroyMethodName = beanElement.attribute("destroy-method") == null ? "" :
                            beanElement.attribute("destroy-method").getValue();
    ...
    // [包装处理器] BeanPostProcessor 是在 Bean 对象实例化之后修改 Bean 对象，也可以替换 Bean 对象
    ...
    static class UserDao {
        ...
        public void initDataMethod() {
            System.out.println("类UserDao 执行：init-method");
        }

        public void destroyDataMethod() {
            System.out.println("类UserDao 执行：destroy-method");
        }
    }

    @Data
    static class UserService implements InitializingBean, DisposableBean, BeanNameAware, BeanClassLoaderAware, ApplicationContextAware, BeanFactoryAware {
        private Integer id;
        private String name;
...
<beans>
    ...
    <bean id="userDao" name="userDao" class="com.hundsun.demo.list.e.E_113$UserDao" init-method="initDataMethod" destroy-method="destroyDataMethod"/>

    <bean id="userService" name="userService" class="com.hundsun.demo.list.e.E_113$UserService">
    ...
    <bean id="myBeanPostProcessor" name="myBeanPostProcessor"
          class="com.hundsun.demo.list.e.E_113$MyBeanPostProcessor"/>

    <!-- BeanDefinition 加载完成后，实例化 Bean 对象之前，提供修改 BeanDefinition 属性的机制 -->
    <bean id="myBeanFactoryPostProcessor" name="myBeanFactoryPostProcessor"
          class="com.hundsun.demo.list.e.E_113$MyBeanFactoryPostProcessor"/>
...
----------Cglib实例化策略----------
----------采用了JDK实例化策略----------
类UserDao 执行：init-method
beanFactory = com.hundsun.demo.list.e.E_113$DefaultListableBeanFactory@14acaea5
classLoader = sun.misc.Launcher$AppClassLoader@18b4aac2
BeanName = userService
applicationContext = com.hundsun.demo.list.e.E_113$ClassPathXmlApplicationContext@46d56d67
执行：UserService.afterPropertiesSet
类名：E_113$UserService$$EnhancerByCGLIB$$686c75a4, 属性id值：10001, 属性name值：普通管理员
[张三, 李四, 王五]
类UserDao 执行：destroy-method
