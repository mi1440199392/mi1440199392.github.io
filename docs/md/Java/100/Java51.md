 ...
 * @Desc 向虚拟机注册钩子，实现Bean对象的初始化和销毁方法
 * @Date 2022-9-6
 */
public class E_112 {
...
<beans>
    ...
    <bean id="userDao" name="userDao" class="com.hundsun.demo.list.e.E_112$UserDao" init-method="initDataMethod" destroy-method="destroyDataMethod"/>

    <bean id="userService" name="userService" class="com.hundsun.demo.list.e.E_112$UserService">
    ...
    <bean id="myBeanPostProcessor" name="myBeanPostProcessor"
          class="com.hundsun.demo.list.e.E_112$MyBeanPostProcessor"/>

    <!-- BeanDefinition 加载完成后，实例化 Bean 对象之前，提供修改 BeanDefinition 属性的机制 -->
    <bean id="myBeanFactoryPostProcessor" name="myBeanFactoryPostProcessor"
          class="com.hundsun.demo.list.e.E_112$MyBeanFactoryPostProcessor"/>
...
类名：E_112$UserService$$EnhancerByCGLIB$$5a354ae1, 属性id值：10001, 属性name值：普通管理员
[张三, 李四, 王五]
